...
formatter:
	black melior_transformers tests --exclude melior_transformers/experimental\|melior_transformers/classification/transformer_models\|melior_transformers/custom_models
	
lint: clean
	flake8 melior_transformers tests --exclude=melior_transformers/experimental,melior_transformers/classification/transformer_models,melior_transformers/custom_models
